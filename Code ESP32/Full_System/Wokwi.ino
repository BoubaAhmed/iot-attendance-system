...
void loadStudents() {
    logInfo("Fetching students from Firebase...");
    ...
    logInfo("Student loaded: " + students[studentCount].name +
        " | FP ID: " + String(students[studentCount].fingerprintId) +
        " | Group: " + students[studentCount].group);

    logInfo("Students loaded: " + String(studentCount));
